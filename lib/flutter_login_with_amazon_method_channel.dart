...
class MethodChannelFlutterLoginWithAmazon
    extends FlutterLoginWithAmazonPlatform {
  ...
  /// To retrieve an authcode for an amazon enabled device through LWA
  /// Device requires code verifier generation. This code verifier should be
  /// unique to the device.
  ///
  /// [codeChallenge] should be generated on the device this is either the
  /// code verifier, or a base64url encoding of the code verifier after it
  /// is SHA256 encoded
  ///
